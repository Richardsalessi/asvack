...
@section('content')
    <div class="container mx-auto p-8 bg-white dark:bg-gray-800 shadow rounded-lg">
        <h1 class="text-3xl font-semibold text-gray-800 dark:text-white mb-6">Dashboard Administrador</h1>
        <p class="text-gray-600 dark:text-gray-300 mb-4">Bienvenido, {{ Auth::user()->name }}.</p>
